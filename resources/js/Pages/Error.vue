...
<template>
	...
	<div class="grid h-screen place-items-center">
		<SectionCard>
			<div class="gap-3 flex flex-col items-center justify-center p-5 md:p-10">
				<h1 class="text-2xl text-danger font-bold">{{ title }}</h1>
				<div class="text-lg text-light font-semibold">{{ description }}</div>
				<div>
					<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 480 360">
						<defs>
							<linearGradient id="BG" x1="19.496%" x2="77.479%" y1="71.822%" y2="16.69%">
								<stop offset="0%" stop-color="#fda92d"></stop>
								<stop offset="100%" stop-color="#fda92d" stop-opacity="0"></stop>
							</linearGradient>
							<linearGradient id="linearGradient-2" x1="-50%" x2="50%" y1="50%" y2="150.001%">
								<stop offset="0%" stop-color="#FFE16A"></stop>
						...
						<g fill="none" fill-rule="evenodd" stroke="none" stroke-width="1">
							<g fill-rule="nonzero">
								<path
									...
									opacity="0.2"></path>
								<circle cx="182.109" cy="97.623" r="44.623" fill="#FFC107" opacity="0.15"></circle>
								<circle cx="182.109" cy="97.623" r="23.406" fill="url(#linearGradient-2)"></circle>
								<path
									fill="#793908"
									d="M244.878 181.46c34.559 0 62.575 28.016 62.575 62.576 0 34.559-28.016 62.575-62.575 62.575-34.56 0-62.576-28.016-62.576-62.575 0-34.56 28.016-62.576 62.576-62.576zm0 23.186c-21.754 0-39.389 17.635-39.389 39.39 0 21.754 17.635 39.389 39.389 39.389s39.389-17.635 39.389-39.389c0-21.755-17.635-39.39-39.389-39.39z"></path>
								<path
									fill="#fda92d"
